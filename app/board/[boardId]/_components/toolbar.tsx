...
export const Toolbar = ({ setCanvasState, canRedo, canUndo, canvasState, redo, undo }: ToolbarProps) => {
	return (
...
export const ToolbarSkeleton = () => {
	return (
		<div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4 bg-white shadow-md rounded-md h-[360px] w-[52px] overflow-hidden">
